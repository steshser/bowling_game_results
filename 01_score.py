...
parser = argparse.ArgumentParser(description='Расчет количество очков в боулинге')
parser.add_argument('game_result', type=str, help='Введите результат игры в боулинг. '
                                                  'Всего 10 кеглей. Игра состоит из 10 фреймов. '
                                                  'В одном фрейме до 2х бросков, цель - сбить все кегли')
args = parser.parse_args()

if __name__ == '__main__':
    score = bowling.InternalGameResult(args.game_result)
    print('Количество очков для результатов {} - {}'.format(args.game_result, score.get_score()))
